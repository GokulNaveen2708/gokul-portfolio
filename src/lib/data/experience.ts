...
export const experiences: Experience[] = [
  {
    ...
    logo: "/logos/ReliableSoftware.png",
    website: "https://www.reliablesoftware.com",
    ...
    highlights: [
      ...
      "Circuit-breaker patterns reducing incidents by 25%",
  ...
  },
  {
    ...
    highlights: [
      "Spring Boot microservices for campus event platform (5,000+ students)",
      "AWS EC2 & Lambda with auto-scaling, achieving 99.9% uptime SLA",
      "Reduced API latency from 5s to under 1s via Redis caching",
      "CI/CD pipelines with GitHub Actions & zero-downtime blue-green deployments",
      "Fault-tolerant REST APIs with circuit breakers & retry logic",
    ],
    responsibilities: [
  ...
  },
  {
    ...
    highlights: [
      "AI microservices platform processing 10M+ daily transactions (Python, gRPC, Kafka)",
      "Real-time risk assessment pipeline on GCP, reducing fraud latency by 65%",
      "Reduced fraud detection false positives by 16% with ensemble ML models",
      "Kafka pipelines with exactly-once semantics, handling 50K messages/sec",
      "Prometheus & Grafana observability, reducing MTTD by 40%",
    ],
    responsibilities: [
