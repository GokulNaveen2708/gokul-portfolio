...
import { ProjectPageActions } from "@/components/projects/ProjectPageActions";
...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-0 sm:py-16">
      ...
      {/* Top section: image on left (3/4) and action buttons on right (1/4) for md+ */}
      <div className="mt-4 flex flex-col md:flex-row md:items-start md:gap-6">
        <div className="w-full md:w-3/4">
          ...
          <div className="mt-8 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-fg-muted sm:text-base">
