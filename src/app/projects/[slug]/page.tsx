...
export default async function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-0 sm:py-16">
      ...
      {/* Top section: main content column and small right column reserved for actions/icon alignment */}
      <div className="mt-4 grid grid-cols-1 md:grid-cols-[1fr_72px] md:gap-6 md:items-start">
        <div className="w-full">
          ...
          <div className="mt-6 flex flex-col space-y-2 md:mt-8text-left md:pr-[72px]">
            <h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-fg-muted">
              Highlights
            </h2>
            <ul className=" flex flex-col space-y-4 text-sm text-fg-muted sm:text-base">
